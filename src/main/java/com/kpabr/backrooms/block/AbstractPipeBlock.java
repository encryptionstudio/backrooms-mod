...
public class AbstractPipeBlock extends Block implements Waterloggable{
	...
	public BlockState getPlacementState(ItemPlacementContext ctx) {
		...
		return this.getDefaultState()
				.with(DOWN, shouldConnect(blockView.getBlockState(blockPos.down())))
				.with(UP, shouldConnect(blockView.getBlockState(blockPos.up())))
				.with(NORTH, shouldConnect(blockView.getBlockState(blockPos.north())))
				.with(EAST, shouldConnect(blockView.getBlockState(blockPos.east())))
				.with(SOUTH, shouldConnect(blockView.getBlockState(blockPos.south())))
				.with(WEST, shouldConnect(blockView.getBlockState(blockPos.west())))
