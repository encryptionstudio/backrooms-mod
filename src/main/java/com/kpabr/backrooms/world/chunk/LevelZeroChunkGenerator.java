...
public class LevelZeroChunkGenerator extends ChunkGenerator {
    ...
    public static final Codec<LevelZeroChunkGenerator> CODEC = Codec.unit(new LevelZeroChunkGenerator());
	...
	public LevelZeroChunkGenerator() {
		super(new LevelZeroBiomeSource());
	}
    ...
    //     BackroomsMod.LOGGER.info(chunk.toString());
